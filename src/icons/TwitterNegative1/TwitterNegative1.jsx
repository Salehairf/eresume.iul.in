...
export const TwitterNegative1 = ({ className }) => {
  return (
    <svg
      className={`twitter-negative-1 ${className}`}
      fill="none"
      height="33"
      viewBox="0 0 33 33"
      width="33"
    ...
    >
      <g className="g" clipPath="url(#clip0_1039_174)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1039_174">
          <rect
            className="rect"
            fill="white"
            height="32.4752"
